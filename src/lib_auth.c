...
static Value lib_auth_hash_sha256(VM *vm, int arg_count, Value *args) {
    ...
    const char *input = args[0].as.string->chars;
...
static Value lib_auth_sign_jwt(VM *vm, int arg_count, Value *args) {
    ...
    const char *secret = args[1].as.string->chars;
    int secret_len = args[1].as.string->length;
    ...
    char *payload_json = json_encode(vm, args[0], &payload_json_len);
...
static Value lib_auth_verify_jwt(VM *vm, int arg_count, Value *args) {
    ...
    const char *token = args[0].as.string->chars;
    const char *secret = args[1].as.string->chars;
    int secret_len = args[1].as.string->length;
