...
| CSRF wiring | **Built-in** through `shield.csrf()`: same-origin POST forms receive the exact double-submit token; native fields and enhanced headers are both verified. |
